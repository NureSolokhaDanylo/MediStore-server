...
docker compose -f "%REPO_ROOT%\compose.yaml" --env-file "%ENV_PATH%" --project-name medistoreserver up --build -d
if errorlevel 1 exit /b 1

docker compose -f "%REPO_ROOT%\compose.yaml" --env-file "%ENV_PATH%" --project-name medistoreserver down -v
